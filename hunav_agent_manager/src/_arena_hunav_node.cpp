...
namespace hunav
{
  ...
  ArenaHuNavNode::ArenaHuNavNode() : BTnode()
  {
    ...
    set_arena_world_bounds_srv_ =
        this->create_service<hunav_msgs::srv::SetArenaWorldBounds>(
            "set_arena_world_bounds",
            std::bind(&ArenaHuNavNode::setArenaWorldBoundsService, this,
                      std::placeholders::_1, std::placeholders::_2));
  }
  ...
  void ArenaHuNavNode::setArenaWorldBounds(
      const std_msgs::msg::Float32MultiArray &msg)
  {
    ...
    arena_world_bounds = {msg.data[0], msg.data[1], msg.data[2], msg.data[3]};

    btfunc_.setArenaWorldBounds(arena_world_bounds);
  }
  ...
  void ArenaHuNavNode::setArenaWorldBoundsService(
      ...
      std::shared_ptr<hunav_msgs::srv::SetArenaWorldBounds::Response> response)
  {
    try
    {
      setArenaWorldBounds(request->arena_world_bounds);
      response->success = true;
