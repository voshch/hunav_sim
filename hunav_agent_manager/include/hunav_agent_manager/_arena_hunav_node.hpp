...
#include "hunav_msgs/srv/set_arena_world_size.hpp"
...
public:
  ...
  void setArenaWorldSize(const std_msgs::msg::Float32MultiArray &mgs);
...
protected:
  ...
  rclcpp::Service<hunav_msgs::srv::SetArenaWorldSize>::SharedPtr
      set_arena_world_size_srv_;
  void setArenaWorldSizeService(
